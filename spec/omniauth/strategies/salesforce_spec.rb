...
describe OmniAuth::Strategies::TimelyApp do
	strategy = nil
	before do
		OmniAuth.config.test_mode = true
		rack_app = []
		rack_app.stub :call
		strategy = OmniAuth::Strategies::TimelyApp.new rack_app, 'Consumer Key', 'Consumer Secret'
	end
	...
	describe "callback phase" do
		...
		before do
			raw_info = {
				...
				'urls'=> {
					"enterprise" => "https://timelyapp.example/services",
					"metadata" => "https://timelyapp.example/services"
				}
			}
			client = OAuth2::Client.new 'id', 'secret', {:site => 'example.com'}
			access_token = OAuth2::AccessToken.from_hash client, {
				'access_token' => 'token',
				'instance_url' => 'http://instance.timelyapp.example',
				'signature' => 'invalid',
		...
		describe "user id validation" do
			...
			instance_url = 'http://instance.timelyapp.example'
			before do
					client_id = "https://login.timelyapp.com/id/00Dd0000000d45TEBQ/005d0000000fyGPCCY"
